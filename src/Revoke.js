...
function Main(props) {
  ...
  const onUpdateDID = () => {
    ...
    const inputParams = [
      ...
      toVecU8(drData),
      toVecU8(ddData),
      Array.from(new Uint8Array(str2ab(dr))),
      pks.split(","),
    ];
  ...
  const onSearchDID = () => {
    ...
    api.query.didModule.dIDDocument(didURI, (result) => {
      ...
      if (!result.isEmpty) {
        ...
        let didResolutionMetadata = hexToUtf8(
          res.did_resolution_metadata.substr(2).toString()
        );
        let didMedatadata = hexToUtf8(
          res.did_document_metadata.substr(2).toString()
        );
        ...
        let senderAccountId = hexToUtf8(
          res.sender_account_id.substr(2).toString()
        );
        ...
        document.getElementById("didResMetadata").innerHTML =
          "DID Resolution Metadata :-" +
          JSON.stringify(JSON.parse(didResolutionMetadata), undefined, 4);
        document.getElementById("didMetaData").innerHTML =
          "DID Document Metadata :-" +
          JSON.stringify(JSON.parse(didMedatadata), undefined, 4);
        document.getElementById("publicKeys").innerHTML =
        ...
        document.getElementById("blockTimeStamp").innerHTML =
          "Block Timestamp :-" + blockTimeStamp;
        document.getElementById("updatedTimeStamp").innerHTML =
        ...
        console.log(result);
        document.getElementById("didResMetadata").innerHTML =
          "Unable to fetch the DID Resolution Metadata";
      }
    });
  };
  ...
  return (
    ...
    >
      ...
      >
        <input
          type="text"
          placeholder="Input DID URI"
          onChange={(event) => setDIDURI(event.target.value)}
          style={{
            fontSize: "20px",
            color: "green",
          }}
      ...
      >
        ...
        <br />
        <textarea
          placeholder="DID Resolution Metadata"
          onChange={(event) => setDIDResolutionMetadata(event.target.value)}
          style={{
            fontSize: "20px",
            color: "green",
            width: "550px",
        ...
        <br />
        <textarea
          placeholder="DID Document Metadata"
          onChange={(event) => setDIDDocumentMetadata(event.target.value)}
          style={{
            fontSize: "20px",
            color: "green",
            width: "550px",
        ...
        <input
          type="text"
          placeholder="DID Ref"
          onChange={(event) => setDIDRef(event.target.value)}
          style={{
            fontSize: "20px",
            color: "green",
            width: "550px",
